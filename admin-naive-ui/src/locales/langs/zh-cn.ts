const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'system_tenant-dashboard': '租户仪表盘',
    'system_tenant-quota': '租户配额',
    'system_tenant-audit': '租户审计日志',
    'system_sms-channel': '短信渠道',
    'system_sms-template': '短信模板',
    'system_sms-log': '短信日志',
    'system_notify-template': '站内信模板',
    'system_notify-message': '站内信消息',
    system_config: '参数设置',
    system_dept: '部门管理',
    system_post: '岗位管理',
    monitor: '系统监控',
