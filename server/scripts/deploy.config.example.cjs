...
module.exports = {
  ...
  prod: {
    ...
    // ========== 部署路径配置 ==========
    remotePath: '/www/wwwroot/nest-admin-server',     // 远程部署目录
    ...
    // ========== PM2 配置 ==========
    pm2AppName: 'nest_admin_server',      // PM2 应用名称（需与 ecosystem.config.cjs 一致）
  ...
  test: {
    ...
    privateKey: '',
    passphrase: '',
    remotePath: '/www/wwwroot/nest-admin-server-test',
    backupPath: '/www/wwwroot/nest-admin-server-test/backup',
    isBackup: true,
    keepBackups: 3,
    includeEnvFile: false,
    runMigration: false,
    pm2AppName: 'nest_admin_server_test',
  ...
  dev: {
    ...
    privateKey: '',
    passphrase: '',
    remotePath: '/www/wwwroot/nest-admin-server-dev',
    backupPath: '/www/wwwroot/nest-admin-server-dev/backup',
